...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "build-planner_#{Rails.env}"
  ...
  config.web_socket_server_url = 'wss://make.20liters.org/cable'
  config.action_cable.allowed_request_origins = ['https://make.20liters.org', 'http://make.20liters.org']
end
