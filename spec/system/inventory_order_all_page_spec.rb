...
RSpec.describe 'Order all supplies page', type: :system do
  context 'when visited by' do
    it 'anon users redirects to sign_in page' do
      visit order_all_inventories_path
    ...
    it 'inventoryists shows the page' do
      ...
      expect(page).to have_content 'Order any item:'
    end
  ...
  context 'shows items that can be ordered', js: true do
    before :each do
      create_list :part, 3, below_minimum: true, minimum_on_hand: 30, available_count: 200, supplier: nil
      create_list :material, 3, below_minimum: true, minimum_on_hand: 30, available_count: 200, supplier: nil

      @supplier1 = create :supplier
      create_list :part, 2, below_minimum: true, minimum_on_hand: 30, available_count: 2, supplier: @supplier1
      create_list :material, 2, below_minimum: true, minimum_on_hand: 30, available_count: 200, supplier: @supplier1

      @supplier2 = create :supplier
      create_list :part, 4, below_minimum: true, minimum_on_hand: 30, available_count: 200, supplier: @supplier2
